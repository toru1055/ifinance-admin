...
public class SubscriptionHandler extends BaseEntityHandler {
  ...
  protected void add() {
    ...
    System.out.print("name: "); String name = readString(scan);
    System.out.print("url: "); String url = readString(scan);
    System.out.print("private(true/false): "); Boolean privateFlag = readBoolean(scan);
    System.out.print("interval(sec): "); Integer interval = readInt(scan);
    System.out.print("scraper_id: "); Integer scraperId = readInt(scan);
    System.out.print("industry_id: "); Integer industryId = readInt(scan);
    ...
    if(url != null) { subscription.setUrl(url); }
    if(privateFlag != null) { subscription.setPrivateFlag(privateFlag); }
    if(interval != null) { subscription.setInterval(interval); }
    if(scraper != null) { subscription.setScraper(scraper); }
    if(industry != null) { subscription.setFixedIndustry(industry); }
